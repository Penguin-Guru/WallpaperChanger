...
static const char Column_Delims[] = WHITESPACE_CHARACTERS;	// Any character in this array has the same effect.
...
static const char Tag_Delims[] = ",;" WHITESPACE_CHARACTERS;	// Any character in this array has the same effect.
